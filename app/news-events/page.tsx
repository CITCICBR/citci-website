...
export default function NewsEventsPage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col gap-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {eventsData.eventsList.reverse().map((item) => (
                <div
                  key={item.id}
    ...
    {/* CTA */}
      <PageCTA
          color="bg-amber-500"
          heading={eventsData.callToActionContent.heading}
          description={eventsData.callToActionContent.description}
          buttons={eventsData.callToActionContent.buttons}
      />
    </main>
  )
}
